...
const editable: Record<string, Omit<SectionDefinition, keyof Pick<CmsSection, 'id' | 'label' | 'route' | 'summary' | 'paused' | 'status' | 'lastEdited' | 'pageKey'>>> = {
  ...
  'home-services': {
    ...
    mediaSlots: [
      ...
      image('service5', 'Quality control & lab testing image', '/assets/images/service_quality_control_gsm_inspection.jpg'),
    ...
    defaultContent: {
      ...
      service5Title: 'Quality Control & Lab Testing', service5Description: 'Rigorous fabric GSM weight verification, lab testing, inline inspection, and final quality audits to ensure compliance and export readiness.',

...
var observability_1 = require("@/database/observability");
...
function getMongoClient() {
    ...
    var config = (0, config_1.getDatabaseConfig)();
    ...
    (0, observability_1.setupDatabaseObservability)(client);
    ...
    (0, observability_1.setupSecurityAlerting)();
    clientPromise = client.connect();
    if (process.env.NODE_ENV !== 'production') {
        clientPromise.then(function (c) { globalThis.__mongoClient = c; });
    }
    return clientPromise;
}
/**
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getMongoClient()];
                case 1:
                    client = _a.sent();
                    return [2 /*return*/, client.db(config.dbName)];
            }
        });
    });
}

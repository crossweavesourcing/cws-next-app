    ...
    <form action="/api/auth/login/" method="post" className="space-y-5 p-6 sm:p-8">
      ...
      <section className="border border-neutral-200 bg-neutral-50 p-4">
        <div className="mb-4 flex items-start justify-between gap-3">
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[0.16em] text-[#E02424]">
              Password sign-in
            </p>
            <p className="mt-1 text-xs leading-5 text-neutral-600">
              Password sign-ins may use email or authenticator verification based on your 2FA settings.
            </p>
          </div>
          <KeyRound className="h-5 w-5 shrink-0 text-neutral-400" />
        </div>
        ...
        <label className="block min-w-0">
          ...
          <span className="relative mt-2 block">
            ...
            <input
              ...
              className="h-12 w-full border border-neutral-200 bg-white pl-11 pr-12 text-sm text-neutral-950 outline-none transition-colors placeholder:text-neutral-400 focus:border-[#E02424]"
            />
            <button
              type="button"
        ...
        <div className="mt-4 flex flex-col gap-3 border-y border-neutral-200 py-4 sm:flex-row sm:items-start sm:justify-between">
          <label className="flex cursor-pointer items-center gap-3">
            ...
            <span className="select-none text-xs font-bold uppercase tracking-[0.14em] text-neutral-700">
              Remember Me
            </span>
          </label>
        ...
        <button
          type="submit"
          className="mt-4 inline-flex min-h-12 w-full items-center justify-center gap-3 bg-[#E02424] px-5 py-3 text-center text-xs font-bold uppercase tracking-[0.18em] text-white transition-colors hover:bg-neutral-950 disabled:cursor-not-allowed disabled:bg-neutral-800"
        >

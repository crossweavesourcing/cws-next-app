          ...
          return (
            ...
            >
              <div className="relative h-48 w-full overflow-hidden bg-neutral-200">
                ...
                <Link
                  href={`/dashboard/categories/${category._id?.toString()}/edit`}
                  className="absolute z-10 right-3 top-3 flex h-8 w-8 items-center justify-center bg-white shadow-sm transition-colors hover:bg-[#E02424] hover:text-white text-neutral-600"
